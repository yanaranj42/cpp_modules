...
/*   Updated: 2025/05/20 17:27:04 by yanaranj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(ScavTrap const &other) : ClapTrap(other){
	*this = other;
	std::cout << _name << " ScavTrap copy created "<< std::endl;
}
ScavTrap::~ScavTrap(){
...
void ScavTrap::guardGate(){
	std::cout << GREEN"ScavTrap " << this->getName() << " is now in Gate Keeper Mode." << std::endl;
	std::cout << END;
}
void ScavTrap::attack(const std::string &target){
	...
	{
		_pEnergy--;
		std::cout << _name << " ScavTrap attacks " << target << " with " << _pDamage;
